...
[평가 기준]
장소의 설명(overview)이 사용자가 원하는 장소에 얼마나 도움이 될지 판단하세요. 

[평가 예시]
1. 주변에 산책하기 좋은 곳 추천해줘 -> overview에 산책과 관련된 내용이 있으면 높은 점수, 음식점 등의 내용이라면 0점.
2. 카페 추천해줘 -> overview에 카페와 관련된 내용이 있으면 높은 점수, 카페 제외 다른 음식점이라면 0점.
"""
